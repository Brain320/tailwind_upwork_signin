...
function Header() {
    return (
        <div className="flex justify-center items-center py-4 sm:py-0 lg:justify-start w-full sm:fixed sm:t-0 bg-white h-[56px]
        sm:h-[64px] z-50 lg:pl-4">
...
export default function Login() {
    return (
        <>
            <Header  />
            <div className="flex min-h-full justify-center p-4 sm:p-8 items-center">
                <div className="w-full sm:mt-[64px] sm:flex sm:justify-center">
                    <div className="md:border-2 md:border-gray-200 rounded-xl md:px-16 sm:w-2/3 lg:w-1/3 md:mt-8">
                        <div className="w-full">
                            <h2 className="mt-6 text-center text-2xl md:text-3xl md:mb-6 font-bold leading-9 tracking-tight text-gray-900">
                                Log in to Upwork
                            </h2>
                        </div>
                        <form action="#" method="POST" className="mt-3 md:mt-0">
                            <div className="relative rounded-md mb-6 ">
                                ...
                                placeholder:text-gray-400 focus:ring-gray-500 sm:text-sm sm:leading-6"
                            ...
                            <div className="h-10">
                                <button
                                    type="submit"
                                    className="flex w-full justify-center rounded-xl md:text-lg bg-[#108a00] text-base px-3 py-2 leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                >
                                    Continue
                                </button>
                            </div>
                            ...
                            <div className="mt-10">
                                <button
                                    type="submit"
                                    className="relative flex w-full justify-center items-center rounded-xl bg-[#4285f4]
                                px-3 py-2 md:text-lg text-base leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                >
                            ...
                            <div className="mt-6">
                                <button
                                    type="submit"
                                    className="flex w-full items-center justify-center rounded-xl bg-white-600 border-[1.6px]
                                border-black px-3 py-2 md:text-lg text-sm leading-6 text-black shadow-sm
                            ...
                            <div className="mb-10 pb-12 md:pb-16"></div>

                            <p className="btn-separator my-3 mb-12"><span className="font-weight-body"> Don't have an Upwork account?</span>
                            </p>
                            <div className="mt-3 mb-6 text-center">
                                <Link
                                    to="/register"
                                    className="border-green-600 border-2 rounded-xl px-8 py-3 h-40 md:px-20 text-sm md:text-base
            ...
            <div
                className="w-11/12 lg:w-auto lg:mx-8 mx-auto mb-4 py-12 text-white rounded-xl bg-black flex flex-col items-center justify-center">
                <p className="text-xs md:hidden">© 2015 - 2024 Upwork® Global Inc.</p>
                <p className="text-xs md:hidden">Privacy Policy</p>
                <p className="text-xs hidden md:block">© 2015 - 2024 Upwork® Global Inc. Privacy Policy</p>
            </div>
        </>
    )
}